...
_EOF_
	...
	;;
		...
		then
			wget linux.palemoon.org/datastore/release/palemoon-28.11.0.linux-x86_64.tar.xz; tar -xf palemoon-28.11.0.linux-x86_64.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
		...
		then
			wget https://storage-waterfox.netdna-ssl.com/releases/linux64/installer/waterfox-classic-2020.07.en-US.linux-x86_64.tar.bz2; tar -xvjf waterfox-classic-2020.07.en-US.linux-x86_64.tar.bz2
		...
		then
			wget http://us.basilisk-browser.org/release/basilisk-latest.linux64.tar.xz; tar -xvjf basilisk-latest.linux64.tar.xz
