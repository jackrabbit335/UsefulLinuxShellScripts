...
_EOF_
	...
	;;
		...
		then
			wget linux.palemoon.org/datastore/release/palemoon-28.10.0.linux-x86_64.tar.xz; tar -xf palemoon-28.10.0.linux-x86_64.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
