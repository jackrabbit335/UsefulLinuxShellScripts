...
_EOF_
	...
	;;
		...
		then
			wget https://storage-waterfox.netdna-ssl.com/releases/linux64/installer/waterfox-classic-2020.07.1.en-US.linux-x86_64.tar.bz2; tar -xvjf waterfox-classic-2020.07.1.en-US.linux-x86_64.tar.bz2
