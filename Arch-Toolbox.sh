...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://linux.palemoon.org/datastore/release/palemoon-29.4.0.linux-x86_64-gtk3.tar.xz; tar -xvf palemoon-29.4.0.linux-x86_64-gtk3.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-G3.2.5.en-US.linux-x86_64.tar.bz2; gunzip waterfox-G3.2.5.en-US.linux-x86_64.tar.bz2; tar -xvf waterfox-G3.1.0.en-US.linux-x86_64.tar; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox
