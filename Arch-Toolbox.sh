...
_EOF_
	...
	;;
		...
		then
			wget linux.palemoon.org/datastore/release/palemoon-28.7.2.linux-x86_64.tar.bz2; tar -xvf palemoon-28.7.2.linux-x86_64.tar.bz2; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
