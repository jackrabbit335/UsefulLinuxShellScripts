...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-G4.0.1.en-US.linux-x86_64.tar.bz2; gunzip waterfox-G4.0.1.en-US.linux-x86_64.tar.bz2; tar -xvf waterfox-G3.1.0.en-US.linux-x86_64.tar; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox
