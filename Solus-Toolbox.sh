...
InstallAndConquer(){
	...
	;;
		...
		then
			wget https://storage-waterfox.netdna-ssl.com/releases/linux64/installer/waterfox-classic-2020.07.en-US.linux-x86_64.tar.bz2; tar -xvjf waterfox-classic-2020.07.en-US.linux-x86_64.tar.bz2; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
		...
		then
			wget http://us.basilisk-browser.org/release/basilisk-latest.linux64.tar.xz; tar -xvjf basilisk-latest.linux64.tar.xz; sudo mv basilisk /opt && sudo ln -s /opt/basilisk/basilisk /usr/bin/basilisk
