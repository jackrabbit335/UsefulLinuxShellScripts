...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			sudo eopkg install --reinstall -c traceroute ifplugd tcpdump whois iperf cpu-x system.devel linux-current-headers smem
			...
			then
				wget https://cdn1.waterfox.net/waterfox/releases/G5.1.8/Linux_x86_64/waterfox-G5.1.8.tar.bz2; waterfox-G5.1.8.tar.bz2; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
