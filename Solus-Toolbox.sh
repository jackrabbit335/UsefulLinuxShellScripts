...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://github.com/WaterfoxCo/Waterfox/releases/download/G4.1.5/waterfox-G4.1.5.en-US.linux-x86_64.tar.bz2; waterfox-G4.1.5.en-US.linux-x86_64.tar.bz2; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
