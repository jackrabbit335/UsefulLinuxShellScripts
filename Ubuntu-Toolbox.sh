...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-G4.0.4.en-US.linux-x86_64.tar.bz2; waterfox-G4.0.4.en-US.linux-x86_64.tar.bz2; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
