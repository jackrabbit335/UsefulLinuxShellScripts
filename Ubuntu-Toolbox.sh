...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://linux.palemoon.org/datastore/release/palemoon-29.1.1.linux-x86_64-gtk3.tar.xz; tar -xvf palemoon-29.1.1.linux-x86_64-gtk3.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
			...
			then
				wget https://downloads.vivaldi.com/stable/vivaldi-stable_3.7.2218.55-1_amd64.deb; sudo apt install -f
			elif [[ $browser == 8 ]];
			then
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-G3.2.0.en-US.linux-x86_64.tar.bz2; waterfox-G3.2.0.en-US.linux-x86_64.tar.bz2; sudo ln -s ~/waterfox/waterfox /usr/bin/waterfox; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
