...
InstallAndConquer(){
	...
	do
		...
		;;
			...
			then
				wget https://downloads.vivaldi.com/stable/vivaldi-stable_2.9.1705.31-1_amd64.deb; sudo dpkg -i *.deb; sudo apt install -f
			elif [[ $browser == 8 ]];
			then
				wget https://downloads.vivaldi.com/snapshot/vivaldi-snapshot_2.9.1705.30-1_amd64.deb; sudo apt install -f
			elif [[ $browser == 9 ]];
			then
