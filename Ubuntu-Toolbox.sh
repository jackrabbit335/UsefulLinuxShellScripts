...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget https://downloads.vivaldi.com/stable/vivaldi-stable_3.3.2022.47-1_amd64.deb; sudo apt install -f
			elif [[ $browser == 8 ]];
			then
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-classic-2020.09.en-US.linux-x86_64.tar.bz2; tar -xvf waterfox-classic-2020.08.1.en-US.linux-x86_64.tar.bz2; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
