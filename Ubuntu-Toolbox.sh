...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget http://linux.palemoon.org/datastore/release/palemoon-28.16.0.linux-x86_64.tar.xz; tar -xvf palemoon-28.16.0.linux-x86_64.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
			...
			then
				wget https://downloads.vivaldi.com/stable/vivaldi-stable_3.4.2066.106-1_amd64.deb; sudo apt install -f
			elif [[ $browser == 8 ]];
			then
