...
InstallAndConquer(){
	...
	do
		...
		;;
			...
			then
				wget http://linux.palemoon.org/datastore/release/palemoon-28.12.0.linux-x86_64.tar.xz; tar -xvf palemoon-28.12.0.linux-x86_64.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
			...
			then
				wget https://downloads.vivaldi.com/stable/vivaldi-stable_3.2.1967.45-1_amd64.deb; sudo apt install -f
			elif [[ $browser == 8 ]];
			then
			...
			then
				wget https://storage-waterfox.netdna-ssl.com/releases/linux64/installer/waterfox-classic-2020.07.2.en-US.linux-x86_64.tar.bz2; tar -xvf waterfox-classic-2020.07.2.en-US.linux-x86_64.tar.bz2; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
