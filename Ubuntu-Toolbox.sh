...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget http://linux.palemoon.org/datastore/release/palemoon-28.14.0.linux-x86_64.tar.xz; tar -xvf palemoon-28.14.0.linux-x86_64.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
			...
			then
				wget https://cdn.waterfox.net/releases/linux64/installer/waterfox-classic-2020.09.en-US.linux-x86_64.tar.bz2; tar -xvf waterfox-classic-2020.09.en-US.linux-x86_64.tar.bz2; sudo mv waterfox /opt && sudo ln -s /opt/waterfox/waterfox /usr/bin/waterfox
