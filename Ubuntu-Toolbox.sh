...
InstallAndConquer(){
	...
	do
		...
		case $software in
			...
			then
				wget http://linux.palemoon.org/datastore/release/palemoon-29.4.5.linux-x86_64-gtk3.tar.xz; tar -xvf palemoon-29.4.5.linux-x86_64-gtk3.tar.xz; sudo ln -s ~/palemoon/palemoon /usr/bin/palemoon
