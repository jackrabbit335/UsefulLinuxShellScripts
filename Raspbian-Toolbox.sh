	...
	do
		...
		case $software in
			...
			then
				...
				then
					wget https://downloads.vivaldi.com/stable/vivaldi-stable_5.6.2867.46-1_arm64.deb; sudo dpkg -i *.deb; sudo apt install -f
				else	
					wget https://downloads.vivaldi.com/stable/vivaldi-stable_5.6.2867.46-1_armhf.deb; sudo dpkg -i *.deb; sudo apt install -f
				fi
