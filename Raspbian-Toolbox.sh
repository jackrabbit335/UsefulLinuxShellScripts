	...
	do
		...
		case $software in
			...
			then
				...
				then
					wget https://downloads.vivaldi.com/stable/vivaldi-stable_5.2.2623.41-1_arm64.deb; sudo dpkg -i *.deb; sudo apt install -f
				else	
					wget https://downloads.vivaldi.com/stable/vivaldi-stable_5.2.2623.41-1_armhf.deb; sudo dpkg -i *.deb; sudo apt install -f
				fi
			...
			;;
			3)
			sudo apt install -y nmap wavemon iotop gparted gnome-disk-utility baobab lm-sensors inxi lshw pulseaudio*
			;;
			4)
			echo "1 - Rhythmbox"
			echo "2 - Mpv"
